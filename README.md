...
<details>
  ...
  <ul> <li>Change: Adjusted Jackal Kill Cooldown Setting</li> </ul>
  <ul> <li>New Role: Hitman</li> </ul>
  <ul> <li>Bug Fix: Fixed Snitch giving a red flash when Mad Snitch had 1 task left</li> </ul>
  <ul> <li>Bug Fix: Fixed Snitch giving a red flash when Mad Snitch had 1 task left</li> </ul>
  <ul> <li>Bug Fix: Fixed Fortune Teller displaying multiple messages</li> </ul>
  <ul> <li>Bug Fix: Fixed Amnesiac becoming Impostor when remembering Mad Snitch</li> </ul>
  <ul> <li>Bug Fix: Fixed Jackal giving errors to Doomsayer and Fortune Teller</li> </ul>
  <ul> <li>Bug Fix: Fixed Max/Min NK being up to 5</li> </ul>
  <ul> <li>Bug Fix: Fixed Vigilante not able to guess Mad Snitch</li> </ul>
  <ul> <li>New Role: Parasite</li> </ul>
  <ul> <li>Change: Changed the vent position for Mad Snitch</li> </ul>
  <ul> <li>Bug Fix: Fixed Amnesiac becoming Impostor when remembering Jackal</li> </ul>
  </details>
  
  <details>
  <summary> v0.0.3 </summary>
  <ul> <li>New Role: Mad Snitch</li> </ul>
  <ul> <li>New Role: Jackal</li> </ul>
  <ul> <li>Change: Madmate and GA won't show up as winners</li> </ul>
  <ul> <li>Visual Fix: Added Fake Tasks to Madmate</li> </ul>
  <ul> <li>Visual Fix: Changed a word in Incendiary Settings</li> </ul>
  <ul> <li>Bug Fix: Fixed Incendiary showing Errors for Doomsayer</li> </ul>
  <ul> <li>Bug Fix: Fixed Incendiary showing Errors for Fortune Teller</li> </ul>
  <ul> <li>Addition: Changed Lighter's & Brightener's Doomsayer category</li> </ul>
  <ul> <li>Addition: Changed Lighter's & Brightener's Fortune Teller category</li> </ul>
  <ul> <li>Bug Fix: Fixed all guessers unable to guess Brightener</li> </ul>
  <ul> <li>Addition: Added an indicator to show if Knight used their kill</li> </ul>
  <ul> <li>Addition: Added role colors in the ejection screen</li> </ul>
  </details>
  
  <details>
  <summary> v0.0.2 </summary>
  <ul> <li>New Role: Madmate</li> </ul>
  <ul> <li>New Role: Crewmate</li> </ul>
  <ul> <li>New Role: Incendiary</li> </ul>
  <ul> <li>New Role: Nice Watcherr</li> </ul>
  <ul> <li>New Role: Brightener</li> </ul>
  <ul> <li>New Role: Evil Watcher</li> </ul>
  <ul> <li>New Role: Paranoid</li> </ul>
  <ul> <li>New Role: Impostor</li> </ul>
  <ul> <li>Role Improvement: Better Doomsayer Observe Message</li> </ul>
  <ul> <li>Role Improvement: Better Fortune Teller Fortune Messages</li> </ul>
  <ul> <li>New Role: Lighter</li> </ul>
  </details>
  
  <details>
  <summary> v0.0.1 </summary>
  <ul> <li>New Role: Evil Guesser</li> </ul>
  <ul> <li>New Role: Knight</li> </ul>
  <ul> <li>New Role: Witness</li> </ul>
  <ul> <li>New Role: Fortune Teller</li> </ul>
  <ul> <li>Addition: NE, NK, NB appear as Winners</li> </ul>
  <ul> <li>Addition: NE may appear on end screen</li> </ul>
  </details>
</details>
